...
import com.fzy.common.to.MemberPrice;
...
import com.fzy.shop.coupon.dao.SkuFullReductionDao;
import com.fzy.shop.coupon.entity.SkuFullReductionEntity;
import com.fzy.shop.coupon.service.SkuFullReductionService;
...
public class SkuFullReductionServiceImpl extends ServiceImpl<SkuFullReductionDao, SkuFullReductionEntity> implements SkuFullReductionService {
    ...
    public void saveSkuReduction(SkuReductionTo skuReductionTo) {
        ...
        //1、保存满减打折、会员价
        //1、1）、sku的优惠、满减等信息：fzyshop_sms--->sms_sku_ladder、sms_sku_full_reduction、sms_member_price
