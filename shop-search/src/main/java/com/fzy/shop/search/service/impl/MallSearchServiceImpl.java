package com.fzy.shop.search.service.impl;
...
import com.fzy.shop.search.constant.EsConstant;
import com.fzy.shop.search.service.MallSearchService;
import com.fzy.shop.search.vo.AttrResponseVo;
import com.fzy.shop.search.vo.BrandVo;
import com.fzy.shop.search.vo.SearchParam;
import com.fzy.shop.search.vo.SearchResult;
import com.fzy.shop.search.feign.ProductFeignService;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    public SearchResult search(SearchParam param) {
        ...
        try {
            //2、执行检索请求
            SearchResponse response = esRestClient.search(searchRequest, FzyshopElasticSearchConfig.COMMON_OPTIONS);
    ...
    private SearchResult buildSearchResult(SearchResponse response,SearchParam param) {
        ...
        if (param.getAttrs() != null && param.getAttrs().size() > 0) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                navVo.setLink("http://search.fzyshop.com/list.html?" + replace);
        ...
        if (null != param.getBrandId() && param.getBrandId().size() > 0) {
            ...
            if (0 == r.getCode()) {
                ...
                navVo.setLink("http://search.fzyshop.com/list.html" + (replace.isEmpty() ? "" : "?" + replace));
            }
            navs.add(navVo);
        }
